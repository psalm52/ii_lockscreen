...
Item {
    ...
    readonly property bool sessionLockedActive: Settings.lock_showLockedText && Settings.sessionLockedText !== "" // standalone build :: config.* was SDDM-only
            ...
            sourceComponent: Item {
                ...
                Row {
                    ...
                    StyledText {
                        ...
                        text: Settings.sessionLockedText
                        animateChange: false
